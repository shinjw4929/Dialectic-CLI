...
> 사용자 가용 시간 현실 반영 — 평일 회사 후 ~4.5h, 마감일 종일.
...
```
Day 1 (가용 ~3h) ✓ 완료 — .md 하네스 풀 작성 (28 파일)
─ A 개발용 (dev-time):
...
Day 3 (가용 ~4.5h) — 인터랙티브 + plan/implement
